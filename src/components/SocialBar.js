...
export default class SocialBar extends React.Component { 
    render() {
        return <div className="social-bar">
                    <ul>
                        <li>
                            <a target="_blank" href="https://www.linkedin.com/in/collin-bowers/" aria-label="LinkedIn">
                        ...
                        <li>
                            <a target="_blank" href="https://github.com/cbowers1" aria-label="GitHub">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="29px" height="29px">
                                <title>GitHub</title>
                        ...
                        <li>
                            <a target="_blank" href="https://www.instagram.com/collin.pb/" aria-label="Instagram">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="29px" height="29px">
